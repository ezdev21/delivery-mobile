        ...
        return Column(children: [
          ...
          Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(
                _parcel ? orderModel.parcelCategory.name ?? '' : orderModel.storeName, maxLines: 2, overflow: TextOverflow.ellipsis,
                style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
              ),
              Text(
                _parcel ? orderModel.parcelCategory.description ?? '' : orderModel.storeAddress, maxLines: 1, overflow: TextOverflow.ellipsis,
